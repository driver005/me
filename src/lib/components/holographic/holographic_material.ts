...
import type { Blending, Side, Texture } from 'three'
...
class HolographicMaterial extends ShaderMaterial {
   ...
   * @param {object} [parameters.texture] - Pass a texture.
   */
  constructor(parameters: HolographicMaterialParameters = {}) {
    ...
    this.fragmentShader /* GLSL */
      ...
      void main() {
        ...
        scanlineMix.rgb *= textureColor.rgb;
    ...
    this.uniforms = {
      ...
      /**
       * The base texture of the hologram.
       * @type {Uniform<Texture>}
       * @default A 1x1 white texture
       */
      map: new Uniform(
        parameters.texture !== undefined
          ? parameters.texture
          : (() => {
