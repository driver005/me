	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				brutal: "rounded-lg border-2 border-slate-200 bg-white/80 font-black tracking-widest text-slate-400 uppercase",
				mono: "rounded-none border border-black font-mono text-[10px] tracking-[0.2em] text-[#0A0A0A] uppercase",
				solid: "rounded-none border border-black bg-black font-black text-white uppercase",
			},
		},
		defaultVariants: {
			variant: "default",
