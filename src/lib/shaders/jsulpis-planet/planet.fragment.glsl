...
// GPL-3.0 License. Ported verbatim — see CREDITS.md at the repo root for the license
// implications of including it. Mercury/Venus/Mars/Jupiter/Moon textures via the same repo's
// public/ assets (USGS Astrogeology imagery, public domain).
//
//=======================================================================================//
